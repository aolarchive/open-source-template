...
Let people know how they can dive into the project, include important links to things like issue trackers, irc, twitter accounts if applicable. Also add a link for them to [open an issue](https://github.com/aol/open-source-template/issues/new)
